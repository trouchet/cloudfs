...
public:
    ...
    HttpResponse Execute(const HttpRequest &req, const CloudRetryPolicy &policy = CloudRetryPolicy());
    ...
    int64_t ReadRange(const std::string &url,
    ...
    HttpResponse Post(const std::string &url, const std::string &token,
    ...
    HttpResponse Patch(const std::string &url, const std::string &token,
                       const std::string &body, const std::string &ct = "application/json");
